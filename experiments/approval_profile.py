...
class ApprovalProfile():
    def __init__(self, num_voters, num_candidates, committee_size):
        self.num_voters = num_voters
        self.num_candidates = num_candidates
        self.committee_size = committee_size

        self.profile = Profile(preferences_ut=np.random.rand(num_voters, num_candidates))

        self.profile_pref_topk = self.profile.preferences_rk[:,:committee_size]
